...
import { generateCourseSummary } from '../services/logout';
...
export const CourseDetailsPage = () => {
  ...
  const handleGenerateSummary = async () => {
    ...
    const summary = await generateCourseSummary(course.title, course.description);
    setAiSummary(summary || "Failed to generate summary.");
                  ...
                  <div>
                    ...
                    {aiSummary && (
                      <motion.div
                        ...
                        className="mb-8 p-6 bg-indigo-600 text-white rounded-3xl shadow-xl shadow-indigo-200 relative overflow-hidden"
                      >
